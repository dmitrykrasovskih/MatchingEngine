...
class CashTransferOperationMessageWrapper(
    var parsedMessage: GrpcIncomingMessages.CashTransferOperation,
    private val callback: StreamObserver<GrpcIncomingMessages.CashTransferOperationResponse>,
    private val closeStream: Boolean = false,
    var context: CashTransferContext? = null
) : MessageWrapper(
    ...
    fun writeResponse(operationId: String?, status: MessageStatus, errorMessage: String? = null) {
        val responseBuilder = GrpcIncomingMessages.CashTransferOperationResponse.newBuilder()
    ...
    private fun writeClientResponse(response: GrpcIncomingMessages.CashTransferOperationResponse) {
        try {
