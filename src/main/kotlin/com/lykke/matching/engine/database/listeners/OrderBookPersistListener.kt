...
class OrderBookPersistListener(
    private val updatedOrderBooksQueue: BlockingQueue<OrderBookPersistEvent>,
    private val secondaryOrdersAccessor: OrderBookDatabaseAccessor
) : QueueConsumer<OrderBookPersistEvent> {
    companion object {
        private val LOGGER = LogManager.getLogger(OrderBookPersistListener::class.java.name)
    }
