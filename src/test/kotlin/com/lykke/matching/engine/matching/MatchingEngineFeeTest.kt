...
class MatchingEngineFeeTest : MatchingEngineTest() {
    ...
    fun testSellLimitOrderFee() {
        ...
        testOrderBookWrapper.addLimitOrder(
            buildLimitOrder(
                clientId = "Client1", price = 1.21111, volume = 100.0,
        ...
        val limitOrder = buildLimitOrder(
            clientId = "Client2", price = 1.2, volume = -200.0,
            fees = buildLimitOrderFeeInstructions(
                type = FeeType.CLIENT_FEE,
                takerSize = 0.01,
    ...
    fun testBuyLimitOrderFee() {
        ...
        testOrderBookWrapper.addLimitOrder(
            buildLimitOrder(
                clientId = "Client2", price = 1.2, volume = -100.0,
                fees = buildLimitOrderFeeInstructions(
                    type = FeeType.CLIENT_FEE,
                    makerSize = 0.02,
                    targetClientId = "Client4"
        ...
        val limitOrder = buildLimitOrder(
            clientId = "Client1", price = 1.2, volume = 200.0,
            fees = buildLimitOrderFeeInstructions(
                type = FeeType.CLIENT_FEE,
                takerSize = 0.01,
                targetClientId = "Client3"
    ...
    fun testSellMarketOrderFee() {
        ...
        testOrderBookWrapper.addLimitOrder(
            buildLimitOrder(
                clientId = "Client1", price = 1.2, volume = 100.0,
                fees = buildLimitOrderFeeInstructions(
                    type = FeeType.CLIENT_FEE,
                    makerSize = 0.02,
                    targetClientId = "Client4"
        ...
        val limitOrder = buildMarketOrder(
            clientId = "Client2", volume = -100.0,
