...
class SingleLimitOrderPreprocessorTest : AbstractTest() {
    ...
    fun testOrderWithUnknownAssetPair() {
        val messageWrapper =
            messageBuilder.buildLimitOrderWrapper(MessageBuilder.buildLimitOrder(assetId = "UnknownAssetPair"))
        ...
        assertEquals(MessageStatus.UNKNOWN_ASSET.type, response.status.number)
