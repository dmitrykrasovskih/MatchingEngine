...
class MarketOrderPerformanceTest : AbstractPerformanceTest() {
    ...
    fun testPerformance() {
        val averageOrderProcessionTime = Runner.runTests(
            REPEAT_TIMES,
            ::testNoLiqudity,
            ::testNotEnoughFundsClientOrder,
            ::testNotEnoughFundsClientMultiOrder,
            ::testNoLiqudityToFullyFill,
            ::testNotEnoughFundsMarketOrder,
            ::testSmallVolume,
            ::testMatchOneToOne,
            ::testMatchOneToOneAfterNotEnoughFunds,
            ::testMatchOneToMany,
            ::testMatchOneToOneEURJPY,
            ::testMatchOneToMany2016Dec12,
            ::testNotStraight,
