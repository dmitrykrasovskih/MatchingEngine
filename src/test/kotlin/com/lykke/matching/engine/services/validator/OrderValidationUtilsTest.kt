...
class OrderValidationUtilsTest {
    ...
    fun testCheckVolume() {
        assertTrue {
            OrderValidationUtils.checkMinVolume(
        ...
        assertTrue {
            OrderValidationUtils.checkMinVolume(
                MessageBuilder.buildLimitOrder(volume = 1.0),
                MIN_VOLUME_ASSET_PAIR
            )
        }
        assertTrue {
            OrderValidationUtils.checkMinVolume(
                MessageBuilder.buildLimitOrder(volume = 0.1),
                MIN_VOLUME_ASSET_PAIR
            )
        }
        assertFalse {
            OrderValidationUtils.checkMinVolume(
                MessageBuilder.buildLimitOrder(volume = 0.09),
                MIN_VOLUME_ASSET_PAIR
            )
        }
        ...
        assertTrue {
            OrderValidationUtils.checkMinVolume(
                MessageBuilder.buildLimitOrder(price = 1.0, volume = 1.0),
                MIN_VOLUME_ASSET_PAIR
            )
        }
        assertTrue {
            OrderValidationUtils.checkMinVolume(
                MessageBuilder.buildLimitOrder(price = 1.0, volume = 0.1),
                MIN_VOLUME_ASSET_PAIR
            )
        }
        assertFalse {
            OrderValidationUtils.checkMinVolume(
                MessageBuilder.buildLimitOrder(price = 1.0, volume = 0.09),
                MIN_VOLUME_ASSET_PAIR
            )
        }
        ...
        assertTrue {
            OrderValidationUtils.checkMinVolume(
                MessageBuilder.buildMarketOrder(
                    assetId = "BTCUSD",
                    volume = 1.0
                ), BTC_USD_ASSET_PAIR
            )
        ...
        assertTrue {
            OrderValidationUtils.checkMinVolume(
                MessageBuilder.buildMarketOrder(volume = 1.0),
                MIN_VOLUME_ASSET_PAIR
            )
        }
        assertTrue {
            OrderValidationUtils.checkMinVolume(
                MessageBuilder.buildMarketOrder(volume = 0.1),
                MIN_VOLUME_ASSET_PAIR
            )
        }
        assertFalse {
            OrderValidationUtils.checkMinVolume(
                MessageBuilder.buildMarketOrder(volume = 0.09),
                MIN_VOLUME_ASSET_PAIR
            )
        }
